...
chooseFrame=Frame(root,bg='SkyBlue')
...
toLabelFrame=LabelFrame(root,text='To (Email Address)',font=('times new roman',16,'bold'),bd=5,fg='white',bg='SkyBlue')
...
browseButton=Button(toLabelFrame,text=' Browse',image=browseImage,compound=LEFT,font=('arial',12,'bold'),
       cursor='hand2',bd=0,bg='SkyBlue',activebackground='SkyBlue',state=DISABLED,command=browse)
browseButton.grid(row=0,column=1,padx=20)

subjectLabelFrame=LabelFrame(root,text='Subject',font=('times new roman',16,'bold'),bd=5,fg='white',bg='SkyBlue')
...
emailLabelFrame=LabelFrame(root,text='Compose Email',font=('times new roman',16,'bold'),bd=5,fg='white',bg='SkyBlue')
...
Button(root,image=sendImage,bd=0,bg='SkyBlue',cursor='hand2',activebackground='SkyBlue'
       ,command=send_email).place(x=490,y=540)

clearImage=PhotoImage(file='clear.png')
Button(root,image=clearImage,bd=0,bg='SkyBlue',cursor='hand2',activebackground='SkyBlue'
       ,command=clear).place(x=590,y=550)

exitImage=PhotoImage(file='exit.png')
Button(root,image=exitImage,bd=0,bg='SkyBlue',cursor='hand2',activebackground='SkyBlue'
       ,command=iexit).place(x=690,y=550)

totalLabel=Label(root,font=('times new roman',18,'bold'),bg='SkyBlue',fg='black')
totalLabel.place(x=10,y=560)

sentLabel=Label(root,font=('times new roman',18,'bold'),bg='SkyBlue',fg='black')
sentLabel.place(x=100,y=560)

leftLabel=Label(root,font=('times new roman',18,'bold'),bg='SkyBlue',fg='black')
leftLabel.place(x=190,y=560)

failedLabel=Label(root,font=('times new roman',18,'bold'),bg='SkyBlue',fg='black')
